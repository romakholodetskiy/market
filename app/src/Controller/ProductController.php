...
use App\ResponseDto\ProductDtoFactory;
...
final class ProductController extends AbstractController
{
    ...
    public function showAll(ProductService $productService, ProductDtoFactory $dtoFactory): JsonResponse
    {
        $products = $productService->showAll();

        return $this->json($dtoFactory->createList($products), Response::HTTP_OK);
    }
    ...
    public function change(
        int $id,
        #[MapRequestPayload] ProductChangeDto $productChangeDto,
        ProductService $productService
    ) {
